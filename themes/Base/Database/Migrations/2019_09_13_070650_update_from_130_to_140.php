...
//        });
        ...
        Schema::table('bravo_communitys', function (Blueprint $table) {
            if (!Schema::hasColumn('bravo_community', 'include')) {
                $table->text('include')->nullable();
            }
            if (!Schema::hasColumn('bravo_community', 'exclude')) {
                $table->text('exclude')->nullable();
            }
            if (!Schema::hasColumn('bravo_community', 'itinerary')) {
                $table->text('itinerary')->nullable();
            }
        });

        Schema::table('bravo_community_translations', function (Blueprint $table) {
            if (!Schema::hasColumn('bravo_community_translations', 'include')) {
                $table->text('include')->nullable();
            }
            if (!Schema::hasColumn('bravo_community_translations', 'exclude')) {
                $table->text('exclude')->nullable();
            }
            if (!Schema::hasColumn('bravo_community_translations', 'itinerary')) {
                $table->text('itinerary')->nullable();
            }
        });
