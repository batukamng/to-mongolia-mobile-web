...
class CreateBravoCommunitysMetaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bravo_community_meta', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bravo_community_meta');
    }
}
