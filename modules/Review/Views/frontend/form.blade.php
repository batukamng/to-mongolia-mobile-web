                    ...
                    <form action="{{ route('review.store')}}" class="needs-validation" novalidate method="post">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-8">
                                <div class="form-group">
                                    <textarea name="review_content" style="min-height:150px!important;" required class="form-control" placeholder="{{__("Review content")}}" minlength="10"></textarea>
                            ...
                            @if($tour_review_stats = setting_item($row->type."_review_stats"))
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group review-items" style="min-height:150px!important;">
                                        @foreach($tour_review_stats as $item)
                                            <div class="item" @if($item->title =='Safety' || $item->title =='Area Expert' || $item->title =='Friendliness' || $item->title =='Aftercare' || $item->title =='Equipment' || $item->title =='Climate Control'))) hidden @endif>
