...
<div class="row">
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" data-condition="facebook_enable:is(1)">
                    ...
                    <div class="form-controls">
                        <input type="text" name="facebook_client_secret" value="{{setting_item('facebook_client_id')}}" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel">
            <div class="panel-title"><strong>{{__('Kakao Talk')}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label> <input type="checkbox" @if(setting_item('kakao_enable') == 1) checked @endif name="kakao_enable" value="1"> {{__("Enable Kakao Talk Login?")}}</label>
                </div>
                <div class="form-group" data-condition="kakao_enable:is(1)">
                    <label>{{__("Kakao Talk Client Id")}}</label>
                    <div class="form-controls">
                        <input type="text" name="kakao_client_id" value="{{setting_item('kakao_client_id')}}" class="form-control">
                    </div>
                </div>
                <div class="form-group" data-condition="kakao_enable:is(1)">
                    <label>{{__("Kakao Talk Client Secret")}}</label>
                    <div class="form-controls">
                        <input type="text" name="kakao_client_secret" value="{{setting_item('kakao_client_secret')}}" class="form-control">
                    </div>
                </div>
            </div>
        </div>
