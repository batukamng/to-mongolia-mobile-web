...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'To Mongolia'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('To Mongolia by')}} <a href="{{__('https://gcommunication.mn')}}" target="_blank">{{__('G-Comm Team')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://gcommunication.mn/about')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://gcommunication.mn/contact')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
