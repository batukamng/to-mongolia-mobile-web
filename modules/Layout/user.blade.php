...
<head>
    ...
    <script>
        ...
        // function showLabel() {
        //     document.getElementById('show-label').hide();
        //     document.getElementById('show-edit').show();
        // }

        // function showEdit() {
        //     document.getElementById('show-label').show();
        //     document.getElementById('show-edit').hide();
        // }
    </script>
