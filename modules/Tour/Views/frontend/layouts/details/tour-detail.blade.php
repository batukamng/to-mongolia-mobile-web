...
@if(!empty($row->duration) or !empty($row->category_tour->name) or !empty($row->max_people) or !empty($row->location->name))
    <div class="g-tour-feature" style="padding:0px; border: 1px solid #D7DCE3; padding-left:20px!important; border-radius:10px;">
    <div class="row">
        @if($row->duration)
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    <div class="icon">
                        <i class="icofont-wall-clock small" style="font-size:30px;"></i>
                    </div>
        ...
        @if(!empty($row->category_tour->name))
            ...
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    <div class="icon">
                        <i class="icofont-calendar" style="font-size:30px;"></i>
                    </div>
                    <div class="info" style="padding-top:10px;">
                        <!-- <h4 class="name">{{__("Duration")}}</h4> -->
                        <p class="value">
        ...
        @if($row->max_people)
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    <div class="icon">
                        <i class="icofont-travelling small" style="font-size:30px;"></i>
                    </div>
                    <div class="info" style="padding-top:10px;">
        ...
        <!-- @if(!empty($row->location->name))
            ...
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    <div class="icon">
                        <i class="icofont-island-alt small"></i>
                    </div>
                    <div class="info">
                        <p class="value">
                            {{$location->name ?? ''}}
