...
@section ('content')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Communitys Availability Calendar")}}</h1>
        </div>
        ...
        @else
            <div class="alert alert-warning">{{__("No communitys found")}}</div>
        @endif
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                    	url:"{{route('community.admin.availability.loadDates')}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('community.admin.availability.store')}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
