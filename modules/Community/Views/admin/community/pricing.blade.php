<div class="panel">
    ...
    <div class="panel-body">
        @if(is_default_lang())
            <h3 class="panel-body-title">{{__("Community Price")}}</h3>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Price")}}</label>
                        <input type="text" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Community Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Sale Price")}}</label>
                        <input type="text" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Community Sale Price")}}">
                    </div>
                </div>
                <div class="col-lg-12">
                    <span>
        ...
        @if(is_default_lang() and (!empty(setting_item("community_allow_vendor_can_add_service_fee")) or is_admin()))
            <hr>
