<div class="panel">
    <!-- <div class="panel-title"><strong>{{__("Community Locations")}}</strong></div>
    <div class="panel-body">
        ...
        @endif
        <div class="form-group">
            <label class="control-label">{{__("Real community address")}}</label>
            <input type="text" name="address" id="customPlaceAddress" class="form-control" placeholder="{{__("Real community address")}}" value="{{$translation->address}}">
        </div>
        @if(is_default_lang())
            <div class="form-group">
