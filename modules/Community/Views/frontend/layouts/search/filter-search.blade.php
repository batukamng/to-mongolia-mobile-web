<div class="bravo_filter" style="border-color:white; display:none;">
    <form action="{{url(app_get_locale(false,false,'/').config('community.community_route_prefix'))}}" class="bravo_form_filter">
        ...
        <!-- <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    <?php
                    $price_min = $pri_from = floor ( App\Currency::convertPrice($community_min_max_price[0]) );
                    $price_max = $pri_to = ceil ( App\Currency::convertPrice($community_min_max_price[1]) );
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <ul>
                    ...
                    $traverse($community_category);
                    ?>
                </ul>
                @if(count($community_category) > 3 and empty($current_category_ids))
