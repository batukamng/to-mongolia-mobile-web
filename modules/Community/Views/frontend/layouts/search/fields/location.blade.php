@php($location_search_style = setting_item('community_location_search_style'))
<div class="form-group">
	...
	<div class="form-content">
		...
		@else
            ...
            $traverse($community_location);
            ?>
			<div class="smart-search" >
				<input type="text" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("community_location_search_style")) or setting_item("community_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Where are you going?")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"
