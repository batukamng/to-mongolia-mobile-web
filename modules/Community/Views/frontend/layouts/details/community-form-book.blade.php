<div class="bravo_single_book_wrap @if(setting_item('community_enable_inbox')) has-vendor-box @endif">
    <div class="bravo_single_book">
        <div id="bravo_community_book_app" v-cloak>
            <!-- @if($row->discount_percent)
                <div class="community-sale-box">
            ...
            <div class="nav-enquiry" style="background-color:#5191fa!important;" v-if="is_form_enquiry_and_book">
                <!-- <div class="enquiry-item active" >
                    <span>{{ __("Book") }}</span>
                </div> -->
                <div class="enquiry-item" style="margin-left:50px;" data-toggle="modal" data-target="#enquiry_form_modal">
                    <span style="color:white;">{{ __("Send request") }}</span>
                </div>
            </div>
                    ...
                    <div class="form-group form-date-field form-date-search clearfix " data-format="{{get_moment_date_format()}}">
                        <div class="d-flex p-2  flex-wrap clearfix text-center" v-if="is_fixed_date">
                            <div class="w-50 py-3 flex-grow-1">
                                <div class="font-weight-bold">{{__("Community Start Date")}}</div>
                                <span>@{{ start_date_html }}</span>
                            </div>
                            <div class="w-50 py-3 flex-grow-1 border-left">
                                <div class="font-weight-bold">{{__("Community End Date")}}</div>
...
@include("Booking::frontend.global.enquiry-form",['service_type'=>'community'])
