...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Community\Controllers';

    protected $adminModuleNamespace = 'Modules\Community\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix(config('admin.admin_route_prefix').'/module/community')
