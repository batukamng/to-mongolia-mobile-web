...
class AttributeController extends AdminController
{
    ...
    {
        $this->checkPermission('community_manage_attributes');
        $listAttr = $this->attributesClass::where("service", 'community');
        ...
        return view('Community::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'community')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Community'),
        ...
        return view('Community::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Community::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('community.admin.attribute.term.index',['attr_id'=>$row->attr_id])
                ],
                [
        ...
        return view('Community::admin.terms.detail', $data);
    }
