...
class CreateCommunityDatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('bravo_community_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bravo_community_dates');
    }
}
