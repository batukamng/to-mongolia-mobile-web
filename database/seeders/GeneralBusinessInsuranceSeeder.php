...
class GeneralBusinessInsuranceSeeder extends Seeder
{
    /**
    ...
    {
        return '<h2>Insurance information</h2>
        ...
        return [
            ...
            [
                ...
                "model" => [
                    "style" => "tab",
                    "list_item" => [
                        ["_active" => true, "title" => "Exchange", "link" => "/page/exchange"],
                        ["_active" => true, "title" => "Insurance", "link" => "/page/insurance"],
                        ["_active" => true, "title" => "Care Service", "link" => "/page/careservice"],
                    ]
                ]
            ],
            [
