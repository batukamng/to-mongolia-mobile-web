...
class GeneralTipsShopDepartmentSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('core_pages')->insert([
            'title'       => 'Shop: Department Store',
            'slug'        => 'tips-shop-department-store',
    ...
    private function content(): array
    {
        ...
        $catId = LocationCategory::where('name', 'Shop > Department Store')->first()->id;
