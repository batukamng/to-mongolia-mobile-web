...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Community
        Permission::findOrCreate('community_view');
        Permission::findOrCreate('community_create');
        Permission::findOrCreate('community_update');
        Permission::findOrCreate('community_delete');
        Permission::findOrCreate('community_manage_others');
        Permission::findOrCreate('community_manage_attributes');
        ...
        $customer->givePermissionTo('community_view');
        $customer->givePermissionTo('community_create');
        $customer->givePermissionTo('community_update');
        $customer->givePermissionTo('community_delete');

        $customer->givePermissionTo('news_view');
        $customer->givePermissionTo('news_create');
        $customer->givePermissionTo('news_update');
        $customer->givePermissionTo('news_delete');

        $customer->givePermissionTo('coupon_view');
