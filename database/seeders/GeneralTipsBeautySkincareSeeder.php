...
class GeneralTipsBeautySkincareSeeder extends Seeder
{
    /**
    ...
    private function content(): array
    {
        ...
        $catId = LocationCategory::where('name', 'Beauty > Skin Care')->first()->id;
            ...
            [
                ...
                "model" => [
                    ...
                    "list_item" => [
                        ...
                        ["_active" => true, "title" => "뷰티", "link" => "/page/tips-beauty", "icon" => $this->getIcon("beauty"), "class" => "active"],
