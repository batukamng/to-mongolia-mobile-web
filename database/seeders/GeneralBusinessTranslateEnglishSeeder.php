...
class GeneralBusinessTranslateEnglishSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $templateId = DB::table('core_templates')->insertGetId([
            'title'       => 'Business: Translate English',
    ...
    {
        return '<h2>Translate English</h2>
        ...
        return [
            ...
            [
                ...
                "model" => [
                    "style" => "tab",
                    "list_item" => [
                        ["_active" => true, "title" => "Korean translators", "link" => "/page/translatekorean"],
                        ["_active" => true, "title" => "English translators", "link" => "/page/translateenglish"],
                    ]
                ]
            ],
            [
