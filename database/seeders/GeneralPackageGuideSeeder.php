...
class GeneralPackageGuideSeeder extends Seeder
{
    /**
        ...
        return [
            ...
            [
                ...
                "model" => [
                    "style" => "tab",
                    "list_item" => [
                        ["_active" => true, "title" => "Professional guide", "link" => "/page/pro-mn-guide-tour"],
                        ["_active" => true, "title" => "Local agency", "link" => "/page/mn-local-agency-tour"],
                    ]
                ]
            ],
            [
                ...
                "model" => [
                    "title" => "Professional Mongolian Guide Tours",
