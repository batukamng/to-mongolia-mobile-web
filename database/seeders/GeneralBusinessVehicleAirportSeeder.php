...
class GeneralBusinessVehicleAirportSeeder extends Seeder
{
    /**
    ...
    {
        return '<h2>Vehicle information</h2>
        ...
        return [
            ...
            [
                ...
                "model" => [
                    "style" => "tab",
                    "list_item" => [
                        ["_active" => true, "title" => "Airport pickup", "link" => "/page/carairport"],
                        ["_active" => true, "title" => "Rent", "link" => "/page/carrent"],
                        ["_active" => true, "title" => "Taxi", "link" => "/page/cartaxi"],
                    ]
                ]
            ],
            [
