...
class GeneralTipsBeautyMassageSeeder extends Seeder
{
    /**
    ...
    private function content(): array
    {
        ...
        $catId = LocationCategory::where('name', 'Beauty > Massage')->first()->id;
