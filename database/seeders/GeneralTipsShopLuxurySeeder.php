...
class GeneralTipsShopLuxurySeeder extends Seeder
{
    /**
    ...
    private function content(): array
    {
        ...
        $catId = LocationCategory::where('name', 'Shop > Luxury Brand')->first()->id;
