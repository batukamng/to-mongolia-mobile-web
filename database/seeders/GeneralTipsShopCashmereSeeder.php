...
class GeneralTipsShopCashmereSeeder extends Seeder
{
    /**
    ...
    private function content(): array
    {
        ...
        $catId = LocationCategory::where('name', 'Shop > Cashmere')->first()->id;
